...
- Are there any differences? There is a difference between the total p-
  If yes, what might account for those differences?

Yes, there is a difference. On Wikipedia, the total count is 2208 while
on the data set it’s 2201. These differences may be due to some
passengers buying a ticket but not boarding, so the records show that
they were there; some people may have snuck in or gone under a different
name; or simply a miscount due to lost records.
...
Plotting survival rate according to proportion and sex, we are able to
see how, regardless of age, females had a higher survival rate across
all classes (and crew). We are also able to see how all children in
first and second class survived, while the children in the third class
didn’t fare as well.

- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.

  One of the fishy things seen in q4 was how it seemed like both males
  and females in the first and second classes had a higher and somewhat
