...
Based on this graph, it can be seen how for temperatures between 60 and
70 degrees, the recorded velocity data seems to cluster between 299850
and 300000. For temperatures between 70 and 80 degrees, however, there
is no definitive clustering in the data, there are some data points as
low as 299750 and as high as 300150.
...
Based on this graph, it seem that when Michelson first started recording
his data, the data had a lot of variation. With severe outliers such as
299800 and 300050, it seems hard to be able to make an estimate or even
