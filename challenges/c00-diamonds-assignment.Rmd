...
**Observations**: From the plot above, it can be seen how an increase in carat, for the most part, corresponds to an increase in price.
...
**Observations**: Having added a new variable, we can better see how carat has a major influence in price. Despite the fact that a 5 carat diamond may have a fair cut, the lowest of cuts, it still costs significantly more. This is due to the fact that higher carat diamonds are harder to come across, thus, they cost more.
